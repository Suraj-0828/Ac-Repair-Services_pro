...
<head>
  ...
  <meta name="description" content=" Your submission was successful! Our team will get in touch with you shortly to assist with your needs. We appreciate your interest in our services and look forward to serving you.">
  ...
  <div class="wrapper">
    ...
    <section class="page-title page-title-layout5" style="background-color: #28A3DF">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h1 class="pagetitle__heading text-background">Success</h1>
                    </div>
                </div>
            </div>
        </section>
